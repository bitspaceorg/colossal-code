...
impl App {
    pub(super) fn compute_status_left_initial() -> Result<Line<'static>> {
        Self::compute_status_left_impl(false, edtui::EditorMode::Normal)
    }

    pub(super) fn compute_status_left(&self) -> Result<Line<'static>> {
    ...
    pub(super) fn auto_summarize_hint(&self) -> String {
