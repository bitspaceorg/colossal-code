...
use crate::state_domain::{CompactionEntry, MessageState, MessageType, ToolCallStatus};
...
impl App {
    ...
    pub(super) fn drain_agent_rx(&mut self) -> AgentStreamOutcome {
                ...
                match msg {
                    ...
                    AgentMessage::Done => {
                        ...
                        if self.agent_state.is_compacting {
                            ...
                            if self.compaction_history.len() > super::MAX_COMPACTION_HISTORY {
                            ...
                            let banner_line =
                                format!("{}{}", super::SUMMARY_BANNER_PREFIX, banner_text);
