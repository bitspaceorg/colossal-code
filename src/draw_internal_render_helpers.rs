...
pub(super) struct DrawAreaIndices {
    pub(super) messages_area_idx: usize,
    pub(super) queue_choice_area_idx: Option<usize>,
    pub(super) approval_prompt_area_idx: Option<usize>,
    pub(super) sandbox_prompt_area_idx: Option<usize>,
    pub(super) survey_area_idx: Option<usize>,
    pub(super) infobar_area_idx: Option<usize>,
    pub(super) input_area_idx: usize,
    pub(super) autocomplete_area_idx: Option<usize>,
    pub(super) background_tasks_area_idx: Option<usize>,
    pub(super) help_area_idx: Option<usize>,
    pub(super) resume_area_idx: Option<usize>,
    pub(super) history_panel_area_idx: Option<usize>,
    pub(super) rewind_area_idx: Option<usize>,
    pub(super) todos_area_idx: Option<usize>,
    pub(super) model_selection_area_idx: Option<usize>,
    pub(super) min_areas: usize,
}

impl App {
    pub(super) fn compute_draw_area_indices(
    ...
    pub(super) fn render_input_top_right_indicator(&self, frame: &mut Frame, input_area: Rect) {
        ...
        if let Some((mode_text, mode_color)) = self.safety_state.assistant_mode.to_display() {
            ...
            self.render_indicator_text(frame, input_area, indicator_y, &mode_text, mode_color);
    ...
    pub(super) fn render_optional_draw_sections(
        &mut self,
        frame: &mut Frame,
        areas: &[Rect],
