...
use crate::{App, MessageType, SubAgentContext, session_manager};
...
impl App {
    pub(super) fn render_session_window_with_agent_ui(&mut self, frame: &mut Frame) {
    ...
    pub(super) fn render_sub_agent_fullscreen(
        &mut self,
        frame: &mut Frame,
    ...
    pub(super) fn render_sub_agent_context(
        &mut self,
        frame: &mut Frame,
