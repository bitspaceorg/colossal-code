...
use crate::command_runtime::{apply_command_runtime_route, route_command_runtime};
use crate::commands::{SlashCommandDispatch, dispatch_slash_command};
use crate::spec_cli::{
...
impl App {
    pub(super) fn handle_slash_command(&mut self) {
    ...
    pub(super) async fn handle_spec_command(&mut self, command: &str) {
...
#[cfg(test)]
mod tests {
    use crate::command_runtime::route_command_runtime;
    use crate::commands::{SlashCommandDispatch, dispatch_slash_command};
    ...
    fn slash_dispatch_clear_routes_to_none() {
        ...
        assert!(matches!(
            route,
            crate::command_runtime::CommandRuntimeRoute::None
        ));
    ...
    fn slash_dispatch_export_routes_to_export() {
        ...
        assert!(matches!(
            route,
            crate::command_runtime::CommandRuntimeRoute::Export
        ));
    }
    ...
    fn slash_dispatch_summarize_with_messages_routes_to_compact() {
        ...
        assert!(matches!(
            route,
            crate::command_runtime::CommandRuntimeRoute::Compact(_)
        ));
    }
    ...
    fn slash_dispatch_summarize_empty_routes_to_summarize_empty() {
        ...
        assert!(matches!(
            route,
            crate::command_runtime::CommandRuntimeRoute::SummarizeEmpty
        ));
    }
    ...
    fn slash_dispatch_spec_routes_to_spec() {
        ...
        let route = route_command_runtime(&dispatch, 5);
        match route {
            crate::command_runtime::CommandRuntimeRoute::Spec(cmd) => {
