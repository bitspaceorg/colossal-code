...
use crate::state_domain::AgentConnector;
...
impl App {
    ...
    pub(super) fn format_thinking_tree_line(
        summary: String,
        _token_count: usize,
        _chunk_count: usize,
        is_final: bool,
    ...
    pub(super) fn render_message_with_max_width(
        &self,
        message: &str,
        max_width: usize,
        ...
        if let Some(UiMessageEvent::ToolCallStarted { tool_name, args }) = parsed_event.as_ref() {
            return Text::from(vec![Line::from(vec![
                Self::connector_prefix(connector, true),
