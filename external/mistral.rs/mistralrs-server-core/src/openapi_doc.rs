...
use crate::{
    anthropic::{
        ...
        AnthropicErrorBody, AnthropicImageSource, AnthropicMessage, AnthropicMessageContent,
        AnthropicMessageResponse, AnthropicMessagesRequest, AnthropicResponseContentBlock,
        AnthropicSkillReference, AnthropicSystem, AnthropicThinking, AnthropicTool,
        AnthropicToolChoice, AnthropicUsage, AnthropicWebSearchUserLocation,
        __path_anthropic_count_tokens, __path_anthropic_messages,
    },
    approvals::{
