...
At a high-level, MCP is an opinionated, tool-based JSON-RPC 2.0 protocol that lets clients interact with models through structured _tool calls_ instead of specialised HTTP routes.  
