...
Use a simple model topology to configure ISQ and device mapping for _per-layer_ with a single [YAML file](https://github.com/EricLBuehler/mistral.rs/blob/master/topologies/isq_and_device.yml) (examples [here](https://github.com/EricLBuehler/mistral.rs/tree/master/topologies))!
