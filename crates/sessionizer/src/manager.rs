...
impl SessionManager {
    ...
    pub async fn handle_exec_command_request(
        ...
        let safety_check = assess_command_safety(
            ...
            params
                .ask_for_approval
                .unwrap_or(crate::safety::yolo_mode()),
        ...
        if params.is_background {
            ...
            Ok(ExecCommandOutput {
                ...
                aggregated_output: format!(
                    "Background process started. Session ID: {}. Log file: {}",
            ...
            let aggregated_output_raw =
                String::from_utf8_lossy(&truncate_output(aggregated_buf, cap_bytes).text)
                    .to_string();
